   ...
   $(document).ready(function() {
	...
	<body>
		...
		<br>
			...
			$p=$_Get['prim'];
			$con = mysql_connect("C:\Users\Alex\Desktop\DPS_alex_saad","ernest","xroads66");
			...
			$result = mysql_query("SELECT * FROM l1 WHERE name_last LIKE '$name_last%' AND cause_of_death LIKE '%$cause_of_death%' AND name_first LIKE '$name_first%' AND year(date_on_ledger) LIKE '%$year%' AND interment_at like '%$interment_at%' AND occupation LIKE '%$occupation%' ORDER BY age_years ASC");
